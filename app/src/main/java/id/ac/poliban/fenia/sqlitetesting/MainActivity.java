package id.ac.poliban.fenia.sqlitetesting;
...
import id.ac.poliban.fenia.sqlitetesting.domain.Friend;
import id.ac.poliban.fenia.sqlitetesting.impl.FriendDaoImplSQLite;

public class MainActivity extends AppCompatActivity {
    private List<Friend> data = new ArrayList<>();
    {
        data.add(new Friend("Vita Susanti", "Dago Utara, Bandung", "0812223"));
        data.add(new Friend("Junaidi Abdi", "Paiton, Brobolonggo", "0812226"));
